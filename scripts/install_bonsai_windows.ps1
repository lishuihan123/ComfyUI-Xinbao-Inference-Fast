...
$downloadDir = Join-Path $env:TEMP "xinbao-inference-fast-v100"
$baseUrl = "https://github.com/lishuihan123/ComfyUI-Xinbao-Inference-Fast/releases/download/$ReleaseTag"
...
if ($actualModelHash -ne $expectedModelHash) { throw "Main model SHA256 verification failed: $actualModelHash" }
if ($actualMmprojHash -ne $expectedMmprojHash) { throw "Vision projector SHA256 verification failed: $actualMmprojHash" }
